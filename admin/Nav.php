    ...
    <div class="wrapper">
        ...
        <div class="left-side-menu">
            ...
            <ul class="metismenu side-nav">
                ...
                <li class="side-nav-item">
                    <a href="/admin/index2.php" class="side-nav-link">
                        <i class="dripicons-time-reverse"></i>
                        <span> 上传文件</span>
                        <span class="menu-arrow"></span>
                    </a>
                ...
                <li class="side-nav-item">
                    <a href="/admin/list2.php" class="side-nav-link">
                        <i class="dripicons-time-reverse"></i>
                        <span> 文件链接</span>
                        <span class="menu-arrow"></span>
                    </a>
            ...
            <div class="help-box text-center">
                ...
                <h5 class="mt-3">情侣空间</h5>
                <p class="mb-3">花有重开日 人无再少年</p>
                <a href="https://jieniyou.tttttttttt.top" target="_blank" class="btn btn-outline-primary btn-sm">❤</a>
            </div>
            <!-- end Help Box -->
            <!-- End Sidebar -->
