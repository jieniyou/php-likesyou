            ...
            <div class="col-lg-5">
                <div class="card">
                    ...
                    <div class="card-header pt-4 pb-4 text-center bg-primary">
                        <a href="##">
                            <span style="color: #fff;font-size: 1.2rem;">Like Girl  Login</span>
                        </a>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center w-75 m-auto">
                            <h4 class="text-dark-50 text-center mt-0 font-weight-bold">Like Girl</h4>
...
<footer class="footer footer-alt">
    Copyright © 2024 Chris && <a href="https://blog.jieniyou.eu.org/" target="_blank">解你忧</a> All
    Rights Reserved.
</footer>
